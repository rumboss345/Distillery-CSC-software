...
export const BLEND_RECIPES_2024: BlendRecipeSeed[] = [
  rumBlendRecipe(
    'Dark Rum (60 cases)',
    'Dark Rum',
    '60 cases (~871 L). 585 lbs 93% rum + 975 lbs water. 363 lbs dark brown sugar. 1.74 L YT75. 35% ABV per-liter formula from Liqour Blending FINAL (003).xlsx (Test Dark sheet).',
    585,
    975,
    '93% rum',
    [
      sugarLbs(363, 'Dark brown sugar'),
      colorMl(1741, 'YT75'),
    ],
  ),
  rumBlendRecipe(
  ...
  rumBlendRecipe(
    'Banana Rum (38 cases)',
    'Banana Rum',
    '38 cases (~463 L). 311 lbs 93% rum + 494 lbs water. 3 mL/L banana flavoring. Source: Liqour Blending FINAL (003).xlsx (Banana sheet, scaled).',
    311,
    494,
    '93% rum',
    [
      syrupLbs(103, 'CS1 sweetener'),
      sugarLbs(102, 'White sugar'),
      flavorMl(1389, 'Banana flavoring'),
    ],
  ),
  rumBlendRecipe(
    'Banana Rum (60 cases)',
    'Banana Rum',
    '60 cases (~731 L). 491 lbs 93% rum + 779 lbs water. 3 mL/L banana flavoring. Source: Liqour Blending FINAL (003).xlsx (Banana sheet, scaled).',
    491,
    779,
    '93% rum',
    [
      flavorMl(2192, 'Banana flavoring'),
      sugarLbs(161, 'White sugar'),
      syrupLbs(163, 'CS1 sweetener'),
    ],
  ),
  rumBlendRecipe(
    'Coconut Rum (70 cases)',
    'Coconut Rum',
    '70 cases (920 L). 618 lbs 93% rum + 1,004 lbs water. 406 lbs white sugar. 2.76 L coconut flavor. Source: Liqour Blending FINAL (003).xlsx (Coconut sheet).',
    618,
    1004,
    '93% rum',
    [sugarLbs(406, 'White sugar'), flavorLiters(2.76, 'Natural coconut flavor')],
  ),
  rumBlendRecipe(
    'Spiced Rum (40 cases)',
    'Spiced Rum',
    '40 cases (490 L). 329 lbs 93% rum + 658 lbs water. CS1 syrup only (no granulated sugar). Source: Liqour Blending FINAL (003).xlsx (Spiced sheet).',
    329,
    658,
    '93% rum',
    [
  ...
  rumBlendRecipe(
    ...
    'Coffee Liqueur',
    '60 cases (720 L). 387 lbs 93% rum + 506 lbs water. 800 lbs white sugar. 28% ABV target. Source: Liqour Blending FINAL (003).xlsx (Shaft sheet).',
    387,
    506,
    '93% rum',
    [
      sugarBags(16, 'White sugar'),
      flavorMl(3960, 'Glycerin'),
      flavorMl(31050, 'Coffee flavor'),
      flavorMl(4320, 'Chocolate flavor'),
      flavorMl(5850, 'YT75'),
    ],
  ),
  rumBlendRecipe(
